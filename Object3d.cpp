...
void Object3d::InitializeGraphicsPipeline()
{
	...
	ComPtr<ID3DBlob> gsBlob; // ジオメトリーシェーダオブジェクト
...
void Object3d::Update()
{
	...
	//matWorld *= matBillboard; //ビルボート行列を掛ける
	//matWorld *= matBillboardY; //Y軸ビルボート行列を掛ける
